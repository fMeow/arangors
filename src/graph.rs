//! This module facilitates the building of new named graphs as well as the
...
pub struct GraphOptions {
    ...
    /// on the different DB-Servers. If there are less then these many
    /// copies in the cluster a shard will refuse to write. Writes to shards
