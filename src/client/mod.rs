...
pub trait ClientExt: Sync + Clone {
  ...
  {
    self
      .request(Request::get(url.to_string()).body(text.into()).unwrap())
      .await
  }
  #[inline]
  ...
  {
    self
      .request(Request::post(url.to_string()).body(text.into()).unwrap())
      .await
  }
  #[inline]
  ...
  {
    self
      .request(Request::put(url.to_string()).body(text.into()).unwrap())
      .await
  }
  #[inline]
  ...
  {
    self
      .request(Request::delete(url.to_string()).body(text.into()).unwrap())
      .await
  }
  #[inline]
  ...
  {
    self
      .request(Request::patch(url.to_string()).body(text.into()).unwrap())
      .await
  }
  ...
  {
    self
      .request(Request::connect(url.to_string()).body(text.into()).unwrap())
      .await
  }
  ...
  {
    self
      .request(Request::head(url.to_string()).body(text.into()).unwrap())
      .await
  }
  ...
  {
    self
      .request(Request::options(url.to_string()).body(text.into()).unwrap())
      .await
  }
  ...
  {
    self
      .request(Request::trace(url.to_string()).body(text.into()).unwrap())
      .await
  }
